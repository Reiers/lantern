...
// CheckBlockSignature verifies the BlockSig field of a BlockHeader against the
// expected worker address. Mirrors the Lotus helper of the same name (minus
// opencensus tracing, which Lantern does not ship).
