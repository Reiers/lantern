<div align="center">
  ...
  *Boots in minutes. Verifies everything. No 76 GB snapshot. No third-party trust.*
  ...
  [![Release: v1.5.6](https://img.shields.io/badge/release-v1.5.6-0090ff.svg)](https://github.com/Reiers/lantern/releases)
...
**Current release:** [v1.5.6](https://github.com/Reiers/lantern/releases/tag/v1.5.6) on mainnet + calibration. **In production today** as the chain backend embedded in [Curio Core](https://curiocore.io) and as a secondary node on the mainnet SP `f03678816` (sp.reiers.io).
...
**Current release: [v1.5.6](https://github.com/Reiers/lantern/releases/tag/v1.5.6)** — production on mainnet + calibration.
...
| Release | What landed |
|---|---|
| v1.5.6 (current) | Installer rewrite in the FilBucket pattern: animated spinners, FilBucket-style closing block with `Next steps`, ASCII banner, wallet-skip when stdin isn't a TTY. No source changes from v1.5.5. |
