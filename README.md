<div align="center">
  ...
  *Boots in minutes. Verifies everything. No 76 GB snapshot. No third-party trust.*
  ...
  [![Release: v1.5.4](https://img.shields.io/badge/release-v1.5.4-0090ff.svg)](https://github.com/Reiers/lantern/releases)
...
**Current release:** [v1.5.4](https://github.com/Reiers/lantern/releases/tag/v1.5.4) on mainnet + calibration. **In production today** as the chain backend embedded in [Curio Core](https://curiocore.io) and as a secondary node on the mainnet SP `f03678816` (sp.reiers.io).
...
**Current release: [v1.5.4](https://github.com/Reiers/lantern/releases/tag/v1.5.4)** — production on mainnet + calibration.
...
| Release | What landed |
|---|---|
| v1.5.4 (current) | Installer PATH-detection hotfix for fresh Apple Silicon Macs. Symlink self-heal on re-runs. No source code changes from v1.5.3. |
