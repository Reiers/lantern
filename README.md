<div align="center">
  ...
  *Boots in minutes. Verifies everything. No 76 GB snapshot. No third-party trust.*
  ...
  [![Release: v1.5.5](https://img.shields.io/badge/release-v1.5.5-0090ff.svg)](https://github.com/Reiers/lantern/releases)
...
**Current release:** [v1.5.5](https://github.com/Reiers/lantern/releases/tag/v1.5.5) on mainnet + calibration. **In production today** as the chain backend embedded in [Curio Core](https://curiocore.io) and as a secondary node on the mainnet SP `f03678816` (sp.reiers.io).
...
**Current release: [v1.5.5](https://github.com/Reiers/lantern/releases/tag/v1.5.5)** — production on mainnet + calibration.
...
| Release | What landed |
|---|---|
| v1.5.5 (current) | Dashboard on by default at `http://127.0.0.1:9092/dashboard/`. Installer color-rendering hotfix (real ESC bytes). Installer prompts work when piped through `curl \| bash`. |
